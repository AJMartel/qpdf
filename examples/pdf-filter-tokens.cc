...
// The ColorToGray filter finds all "rg" opertors in the content
...
ColorToGray::handleToken(QPDFTokenizer::Token const& token)
{
    ...
    // they always contain exactly the same non-igorable tokens. The
...
int main(int argc, char* argv[])
{
	...
	pdf.processFile(infilename);
             ...
             iter != pages.end(); ++iter)
        {
            ...
            // When the file is written, or when the pages' contenets
